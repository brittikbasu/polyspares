...
(function() {
	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateServices = function() {
			var _this = this;
				...
				return new Animo({
					...
					el: jQuery("#services .services_block"),
					duration: 700,
					delay: 300,
					template: {
						opacity: [0, 1],
		...
		mywebsite.prototype.animatePortfolio = function() {
			var _this = this;
			return jQuery("#gallery_block .opacity").waypoint(function() {
				return new Animo({
					el: jQuery("#gallery_block .opacity"),
					duration: 600,
					delay: 500,
					template: {
						opacity: [0, 1]
		...
		mywebsite.prototype.animateBlog = function() {
			var _this = this;
			return jQuery("#blog .blog_block").waypoint(function() {
				return new Animo({
